...
public class BosonReader {
   ...
   * @return the string
   */
  private String readString(ReaderCtx ctx, boolean verified, int verifiedType) throws Exception {
  ...
  private Enum readEnum(ReaderCtx ctx, boolean verified, int verifiedType) throws Exception {
    int type = verifiedType;
    if (!verified) {
      type = ctx.buf.readByte();
    }
    if (ENUM == type) {
      verifyReadable(ctx);
      String enumClassName = readString(ctx, false, -1);
      String enumValue = readString(ctx, false, -1);
   ...
   * @return the byte
   */
  private byte readByte(ReaderCtx ctx, boolean verified, int verifiedType) throws Exception {
    int type = verifiedType;
    if (!verified) {
      type = ctx.buf.readByte();
    }
   ...
   * @return the short
   */
  private short readShort(ReaderCtx ctx, boolean verified, int verifiedType) throws Exception {
    int type = verifiedType;
    if (!verified) {
      type = ctx.buf.readByte();
    }
   ...
   * @return the int
   */
  private int readInt(ReaderCtx ctx, boolean verified, int verifiedType) throws Exception {
    int type = verifiedType;
    if (!verified) {
      type = ctx.buf.readByte();
    }
   ...
   * @return the long
   */
  private long readLong(ReaderCtx ctx, boolean verified, int verifiedType) throws Exception {
    int type = verifiedType;
    if (!verified) {
      type = ctx.buf.readByte();
    }
   ...
   * @return the float
   */
  private float readFloat(ReaderCtx ctx, boolean verified, int verifiedType) throws Exception {
    int type = verifiedType;
    if (!verified) {
      type = ctx.buf.readByte();
    }
   ...
   * @return the double
   */
  private double readDouble(ReaderCtx ctx, boolean verified, int verifiedType) throws Exception {
    int type = verifiedType;
    if (!verified) {
      type = ctx.buf.readByte();
    }
   ...
   * @return the boolean
   */
  private boolean readBoolean(ReaderCtx ctx, boolean verified, int verifiedType) throws Exception {
    int type = verifiedType;
    if (!verified) {
      type = ctx.buf.readByte();
    }
   ...
   * @return the char
   */
  private char readChar(ReaderCtx ctx, boolean verified, int verifiedType) throws Exception {
    int type = verifiedType;
    if (!verified) {
      type = ctx.buf.readByte();
    }
   ...
   * @return the array
   */
  private Object readArray(ReaderCtx ctx, boolean verified, int verifiedType) throws Exception {
    int type = verifiedType;
    if (!verified) {
      type = ctx.buf.readByte();
    }
    if (ARRAY == type) {
      ...
      int size = ctx.buf.readInt();
      String componentTypeName = readString(ctx, false, -1);
      Class componentType = ClassUtils.forName(componentTypeName, ctx.loader);
      Object arr = null;
  ...
  private byte[] readByteArray(ReaderCtx ctx, boolean verified, int verifiedType) throws Exception {
    int type = verifiedType;
    if (!verified) {
      type = ctx.buf.readByte();
    }
   ...
   * @return the list
   */
  private List<Object> readList(ReaderCtx ctx, boolean verified, int verifiedType) throws Exception {
    int type = verifiedType;
    if (!verified) {
      type = ctx.buf.readByte();
    }
  ...
  private Set<Object> readSet(ReaderCtx ctx, boolean verified, int verifiedType) throws Exception {
    int type = verifiedType;
    if (!verified) {
      type = ctx.buf.readByte();
    }
   ...
   * @return the map
   */
  private Map<Object, Object> readMap(ReaderCtx ctx, boolean verified, int verifiedType) throws Exception {
    int type = verifiedType;
    if (!verified) {
      type = ctx.buf.readByte();
    }
    if (MAP == type) {
      ...
      for (int i = 0; i < size; i++) {
        verifyReadable(ctx);
        int keyType = ctx.buf.readByte();
        Object key = readType(ctx, keyType);
        int valueType = ctx.buf.readByte();
  ...
  private Object readPolo(ReaderCtx ctx, boolean verified, int verifiedType) throws Exception {
    int type = verifiedType;
    if (!verified) {
      type = ctx.buf.readByte();
    }
    if (POLO == type) {
      ...
      //get class name
      String poloClassName = readString(ctx, false, -1);
  ...
  private Object readJson(ReaderCtx ctx, boolean isArray, int ref, int size) throws Exception {
    ...
    for (int i = 0; i < size; i++) {
      ...
      String key = readString(ctx, false, 0);
      verifyReadable(ctx);
      int valueType = ctx.buf.readByte();
      Object value = readType(ctx, valueType);
  ...
  private Object readReference(ReaderCtx ctx, final boolean verified, int verifiedType) throws Exception {
    int type = verifiedType;
    if (!verified) {
      type = ctx.buf.readByte();
    }
   ...
   * @return the type
   */
  private Object readType(ReaderCtx ctx, int type) throws Exception {
    switch (type) {
      case BYTE:
